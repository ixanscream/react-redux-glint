...
```
if this not clear enough, i can make a video for you and upload it to youtube XD, this is my first app created by react-redux :( i always create apps with dotnet and scafold with react, its mean by generator :D, fullstack
```
